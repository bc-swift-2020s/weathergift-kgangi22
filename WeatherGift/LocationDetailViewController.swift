...
extension LocationDetailViewController: CLLocationManagerDelegate{
    ...
    func handleAuthenticationStatus(status: CLAuthorizationStatus){
        ...
        case .restricted:
            self.oneButtonAlert(title: "Location services denied", message: "Parental controls may be restricting location services in this app.")
        case .denied:
            showAlertToPrivacySetting(title: "User has not authorized location services", message: "Select 'Settings' below to access device settings and enable location services for this app.")
    ...
    func locationManager(_ manager: CLLocationManager, didFailWithError error: Error) {
        print("Error. Failed to get device location")
    }
}
